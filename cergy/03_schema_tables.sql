...
GRANT SELECT                 ON CYT_LOCATIONS        TO ROLE_TECH_CERGY;
...
-- ROLE_AUDITEUR (lecture seule partout)
...
-- ROLE_APPLI_GLPI (DML complet — compte DBLink)
...
GRANT SELECT, INSERT, UPDATE, DELETE ON CYT_ASSET_TRANSFER   TO ROLE_APPLI_GLPI;
